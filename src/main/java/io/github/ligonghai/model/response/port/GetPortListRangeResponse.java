package io.github.ligonghai.model.response.port;
...
public class GetPortListRangeResponse extends BasePageResponse<GetPortListRangeResponse.PortList.PortListsResponse.PortItem> {

    @Setter
    @JacksonXmlProperty(localName = "get_port_list")
    ...
    public static class PortList {
        ...
        public static class PortListsResponse extends BasePageResponse.BaseStatusResponse {
            ...
            public static class PortItem extends BasePageResponse.BaseItem {
                ...
                @JacksonXmlProperty(localName = "port_ranges")
